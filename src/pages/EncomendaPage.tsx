  ...
  return (
    <main>
      <SEO
        ...
        description="Solicite uma obra personalizada — retratos, paisagens ou natureza morta pintados exclusivamente para você. Processo transparente, certificado incluso."
        url="https://alemaovargasmoreira.com.br/encomenda"
      />
