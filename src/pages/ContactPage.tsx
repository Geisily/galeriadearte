...
export function ContactPage() {
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      />
      <div className="mb-12">
        <p className="text-xs text-orange-500 tracking-[0.4em] uppercase mb-2">Fale Conosco</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        {sent ? (
          <div className="flex flex-col justify-center">
            <div className="w-10 h-10 border border-orange-700 rounded-full flex items-center justify-center mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-4 bg-orange-800 text-white text-sm tracking-widest uppercase hover:bg-orange-700 transition-colors"
            >
              Enviar Mensagem
            </button>
          </form>
