...
import { mockArtworks, placeholderImages, testimonials, artistInfo } from '@/lib/mockData'
import type { Artwork } from '@/types'
import { FeaturedSection, NewsletterSection } from '@/components/home/HomeClient'
...
export default async function HomePage() {
  ...
  const encomendaImage = placeholderImages['4']
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          >
            ...
            <Link href="/encomenda" className="btn-primary" style={{ alignSelf: 'flex-start' }}>
              Solicitar Encomenda
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
      ...
      <section style={{ backgroundColor: 'var(--bege-l)', borderTop: '1px solid var(--bege)', borderBottom: '1px solid var(--bege)' }}>
        <div className="max-w-3xl mx-auto px-6 py-20 text-center">
          ...
          >
            &ldquo;Pintar é ver o que os outros passam sem notar.&rdquo;
          </blockquote>
